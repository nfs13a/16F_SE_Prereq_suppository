...
#for fall 2016: 
	...
	Scenario: all students qualify
		Given CSV "testCSV2.csv"
		Then student "000817979" meets the prereqs for CRN "14788" is "true"
		And students "" should be removed from CRN "14788"
	...
	Scenario: simple CRN
		...
		And student "000000001" meets the prereqs for CRN "14788" is "false"
		And students "000000001," should be removed from CRN "14788"

	Scenario: simple CRN
		Given CSV "testCSV3.csv"
		Then student "000817979" meets the prereqs for CRN "14788" is "true"
		And student "000817978" meets the prereqs for CRN "14788" is "true"
		And student "000817977" meets the prereqs for CRN "14788" is "true"
		And student "000148897" meets the prereqs for CRN "14788" is "false"
		And student "000361136" meets the prereqs for CRN "14788" is "false"
		And student "000750483" meets the prereqs for CRN "14788" is "false"
		And student "000860200" meets the prereqs for CRN "14691" is "false"
		And student "000896976" meets the prereqs for CRN "14692" is "false"
		And student "000000001" meets the prereqs for CRN "14788" is "false"
		And student "000000002" meets the prereqs for CRN "14788" is "false"
		And student "000000003" meets the prereqs for CRN "14788" is "false"
		And students "000000001,000000002,000000003," should be removed from CRN "14788"

	Scenario: CRN that has no one taking it
		Given CSV "testCSV1.csv"
		Then student "000817979" meets the prereqs for CRN "14788" is "true"
		And student "000148897" meets the prereqs for CRN "14788" is "false"
		And student "000361136" meets the prereqs for CRN "14788" is "false"
		...
		And student "000860200" meets the prereqs for CRN "14691" is "false"
		And student "000896976" meets the prereqs for CRN "14692" is "false"
		And students "" should be removed from CRN "14691"
	...
	Scenario: testing prereqs
		...
		Then course "14788" has a required earned hrs of "0"
